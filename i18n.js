...
(() => {
  ...
  const I18N = {
    ...
    pl: {
      ...
      'hero.m2.value': 'Telepresence · obraz na żywo · AI',
      'hero.m3.label': 'Pierwszy projekt',
      'hero.m3.value': 'Avatar Platform',
      'hero.figcaption': '<span class="fig-no">Rys. I.</span> Projekcja ortograficzna — pochylenie osi 23,5°. Punkty oznaczają orientacyjny zasięg, nie rzeczywiste wdrożenia.',
      ...
      'apparatus.f2.title': 'Przekaz HD w czasie rzeczywistym',
      'apparatus.f2.body': 'Wideo i dźwięk binauralny z opóźnieniem poniżej sekundy, zaprojektowane na długie dystanse. Zmysły Awatara stają się Twoimi — z opóźnieniem, którego przestajesz zauważać.',
      ...
      'apparatus.f4.title': 'Drugi pilot AI',
      'apparatus.f4.body': 'Tłumaczenie mowy na żywo, rozpoznawanie znaków i obiektów, podpowiedzi tras, gdy Awatar się waha. Cichy domyślnie, wymowny na żądanie.',
      ...
      'dispatch.ch2.label': 'Kanał — ogólny',
      'dispatch.ch3.label': 'Kanał — prasa',
      'dispatch.ch4.label': 'Kanał — kariera',
      'dispatch.ch5.label': 'Indiegogo',
    ...
    uk: {
      ...
      'hero.m2.value': 'Телеприсутність · живе відео · ШІ',
      'hero.m3.label': 'Перший проєкт',
      'hero.m3.value': 'Avatar Platform',
      'hero.figcaption': '<span class="fig-no">Рис. I.</span> Ортографічна проєкція — нахил осі 23,5°. Позначки показують орієнтовне покриття, а не активні розгортання.',
      ...
      'apparatus.f2.title': 'HD‑трансляція в реальному часі',
      'apparatus.f2.body': 'Відео й бінауральний звук із субсекундною затримкою, налаштовані на велику відстань. Чуття Аватара стають твоїми — із затримкою, яку перестаєш помічати.',
      'apparatus.f3.title': 'Керування двома пальцями',
      'apparatus.f3.body': 'Мова керування, запозичена з ігрових кімнат. Лівий палець керує рухом, правий — поглядом: вільне володіння за хвилини, виразність на години.',
      'apparatus.f4.title': 'Другий пілот ШІ',
      'apparatus.f4.body': 'Живий переклад мовлення, розпізнавання знаків і об’єктів, підказки маршруту, коли Аватар вагається. Тихий за замовчуванням, красномовний на запит.',
      ...
      'dispatch.ch2.label': 'Канал — загальний',
      'dispatch.ch3.label': 'Канал — преса',
      'dispatch.ch4.label': 'Канал — вакансії',
      'dispatch.ch5.label': 'Indiegogo',
